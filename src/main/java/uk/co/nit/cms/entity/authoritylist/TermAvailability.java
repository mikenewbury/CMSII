...
@Entity
@Table(name="Term_Availability")
public class TermAvailability extends BaseEntity {	
	...
	public String toString() {
		return "TermAvailability [id=" + id + ", code=" + code + ", displayValue=" + displayValue + ", note=" + note
				+ "]";
	}
